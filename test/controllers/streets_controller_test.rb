...
class StreetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create street" do
    assert_difference('Street.count') do
      post streets_url, params: { street: { mviccalzad: @street.mviccalzad, mviccat: @street.mviccat, mvitcla: @street.mvitcla } }
    end
  ...
  test "should update street" do
    patch street_url(@street), params: { street: { mviccalzad: @street.mviccalzad, mviccat: @street.mviccat, mvitcla: @street.mvitcla } }
