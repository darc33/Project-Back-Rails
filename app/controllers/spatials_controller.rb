class SpatialsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @spatial.save
        ...
        format.json { render :show, status: :created, location: @spatial }
      else
  ...
  def update
    respond_to do |format|
      if @spatial.update(spatial_params)
        ...
        format.json { render :show, status: :ok, location: @spatial }
      else
  ...
  def destroy
    @spatial.destroy
    respond_to do |format|
      format.html { redirect_to spatials_url, notice: 'Spatial was successfully destroyed.' }
  ...
  private
    ...
    def spatial_params
      params.require(:spatial).permit(:auth_name, :auth_srid)
    end
end
